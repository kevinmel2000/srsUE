...
void phch_common::set_metrics(const phch_metrics_t &m) {
  metrics = m;
}
...
void phch_common::set_sync_metrics(const phch_sync_metrics_t &m) {
  sync_metrics = m;
}

void phch_common::get_sync_metrics(phch_sync_metrics_t &m) {
  m = sync_metrics;
}
