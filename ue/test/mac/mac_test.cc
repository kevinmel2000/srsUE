...
void setup_mac_phy_sib2(LIBLTE_RRC_SYS_INFO_BLOCK_TYPE_2_STRUCT *sib2, srslte::srsue::mac *mac, srslte::srsue::phy *phy) {
  // RACH-CONFIGCOMMON
  if (sib2->rr_config_common_sib.rach_cnfg.preambles_group_a_cnfg.present) {
    mac->set_param(srslte::srsue::mac_interface_params::RA_NOFGROUPAPREAMBLES, 
                   liblte_rrc_message_size_group_a_num[sib2->rr_config_common_sib.rach_cnfg.preambles_group_a_cnfg.size_of_ra]);
    mac->set_param(srslte::srsue::mac_interface_params::RA_MESSAGESIZEA, 
                   liblte_rrc_message_size_group_a_num[sib2->rr_config_common_sib.rach_cnfg.preambles_group_a_cnfg.msg_size]);
    mac->set_param(srslte::srsue::mac_interface_params::RA_MESSAGEPOWEROFFSETB, 
  ...
  // PDSCH ConfigCommon
  mac->set_param(srslte::srsue::mac_interface_params::PDSCH_RSPOWER, 
                 sib2->rr_config_common_sib.pdsch_cnfg.rs_power);
  mac->set_param(srslte::srsue::mac_interface_params::PDSCH_PB, 
                 sib2->rr_config_common_sib.pdsch_cnfg.p_b);

  // PUSCH ConfigCommon
  phy->set_param(srslte::srsue::phy_interface_params::PUSCH_EN_64QAM, 
                 sib2->rr_config_common_sib.pusch_cnfg.enable_64_qam);
  phy->set_param(srslte::srsue::phy_interface_params::PUSCH_HOPPING_OFFSET, 
                 sib2->rr_config_common_sib.pusch_cnfg.pusch_hopping_offset);
  phy->set_param(srslte::srsue::phy_interface_params::PUSCH_HOPPING_N_SB, 
                 sib2->rr_config_common_sib.pusch_cnfg.n_sb);
  phy->set_param(srslte::srsue::phy_interface_params::PUSCH_HOPPING_INTRA_SF, 
                 sib2->rr_config_common_sib.pusch_cnfg.hopping_mode == LIBLTE_RRC_HOPPING_MODE_INTRA_AND_INTER_SUBFRAME?1:0);
  phy->set_param(srslte::srsue::phy_interface_params::DMRS_GROUP_HOPPING_EN, 
                 sib2->rr_config_common_sib.pusch_cnfg.ul_rs.group_hopping_enabled?1:0);
  phy->set_param(srslte::srsue::phy_interface_params::DMRS_SEQUENCE_HOPPING_EN, 
                 sib2->rr_config_common_sib.pusch_cnfg.ul_rs.sequence_hopping_enabled?1:0);
  phy->set_param(srslte::srsue::phy_interface_params::PUSCH_RS_CYCLIC_SHIFT, 
                 sib2->rr_config_common_sib.pusch_cnfg.ul_rs.cyclic_shift);
  phy->set_param(srslte::srsue::phy_interface_params::PUSCH_RS_GROUP_ASSIGNMENT, 
  ...
  // PUCCH ConfigCommon
  phy->set_param(srslte::srsue::phy_interface_params::PUCCH_DELTA_SHIFT, 
                 liblte_rrc_delta_pucch_shift_num[sib2->rr_config_common_sib.pucch_cnfg.delta_pucch_shift]);
  phy->set_param(srslte::srsue::phy_interface_params::PUCCH_CYCLIC_SHIFT, 
                 sib2->rr_config_common_sib.pucch_cnfg.n_cs_an);
  phy->set_param(srslte::srsue::phy_interface_params::PUCCH_N_PUCCH_1, 
                 sib2->rr_config_common_sib.pucch_cnfg.n1_pucch_an);
  phy->set_param(srslte::srsue::phy_interface_params::PUCCH_N_RB_2, 
  ...
  // PRACH Configcommon
  phy->set_param(srslte::srsue::phy_interface_params::PRACH_ROOT_SEQ_IDX, 
                 sib2->rr_config_common_sib.prach_cnfg.root_sequence_index);
  phy->set_param(srslte::srsue::phy_interface_params::PRACH_HIGH_SPEED_FLAG, 
                 sib2->rr_config_common_sib.prach_cnfg.prach_cnfg_info.high_speed_flag?1:0);
  phy->set_param(srslte::srsue::phy_interface_params::PRACH_FREQ_OFFSET, 
                 sib2->rr_config_common_sib.prach_cnfg.prach_cnfg_info.prach_freq_offset);
  phy->set_param(srslte::srsue::phy_interface_params::PRACH_ZC_CONFIG, 
                 sib2->rr_config_common_sib.prach_cnfg.prach_cnfg_info.zero_correlation_zone_config);
  phy->set_param(srslte::srsue::phy_interface_params::PRACH_CONFIG_INDEX, 
  ...
  if (sib2->rr_config_common_sib.srs_ul_cnfg.present) {
    phy->set_param(srslte::srsue::phy_interface_params::SRS_CS_BWCFG, sib2->rr_config_common_sib.srs_ul_cnfg.bw_cnfg);
    phy->set_param(srslte::srsue::phy_interface_params::SRS_CS_SFCFG, sib2->rr_config_common_sib.srs_ul_cnfg.subfr_cnfg);
    phy->set_param(srslte::srsue::phy_interface_params::SRS_CS_ACKNACKSIMUL, sib2->rr_config_common_sib.srs_ul_cnfg.ack_nack_simul_tx);
  }
...
void process_connsetup(LIBLTE_RRC_CONNECTION_SETUP_STRUCT *msg, srslte::srsue::mac *mac, srslte::srsue::phy *phy) {
  
  // FIXME: There's an error parsing the connectionSetup message. This value is hard-coded: 
 
  if (msg->rr_cnfg.phy_cnfg_ded_present) {
    phy->set_param(srslte::srsue::phy_interface_params::PUCCH_N_PUCCH_SR, 
                  msg->rr_cnfg.phy_cnfg_ded.sched_request_cnfg.sr_pucch_resource_idx);
    phy->set_param(srslte::srsue::phy_interface_params::SR_CONFIG_INDEX, 
                  msg->rr_cnfg.phy_cnfg_ded.sched_request_cnfg.sr_cnfg_idx);
    phy->set_param(srslte::srsue::phy_interface_params::UCI_I_OFFSET_ACK, msg->rr_cnfg.phy_cnfg_ded.pusch_cnfg_ded.beta_offset_ack_idx);
    phy->set_param(srslte::srsue::phy_interface_params::UCI_I_OFFSET_CQI, msg->rr_cnfg.phy_cnfg_ded.pusch_cnfg_ded.beta_offset_cqi_idx);
    phy->set_param(srslte::srsue::phy_interface_params::UCI_I_OFFSET_RI, msg->rr_cnfg.phy_cnfg_ded.pusch_cnfg_ded.beta_offset_ri_idx);
  
    if (msg->rr_cnfg.phy_cnfg_ded.srs_ul_cnfg_ded_present && msg->rr_cnfg.phy_cnfg_ded.srs_ul_cnfg_ded.setup_present) {
      phy->set_param(srslte::srsue::phy_interface_params::SRS_UE_CS, msg->rr_cnfg.phy_cnfg_ded.srs_ul_cnfg_ded.cyclic_shift);
      phy->set_param(srslte::srsue::phy_interface_params::SRS_UE_DURATION, msg->rr_cnfg.phy_cnfg_ded.srs_ul_cnfg_ded.duration);
      phy->set_param(srslte::srsue::phy_interface_params::SRS_UE_NRRC, msg->rr_cnfg.phy_cnfg_ded.srs_ul_cnfg_ded.freq_domain_pos);
      phy->set_param(srslte::srsue::phy_interface_params::SRS_UE_BW, msg->rr_cnfg.phy_cnfg_ded.srs_ul_cnfg_ded.srs_bandwidth);
      phy->set_param(srslte::srsue::phy_interface_params::SRS_UE_CONFIGINDEX, msg->rr_cnfg.phy_cnfg_ded.srs_ul_cnfg_ded.srs_cnfg_idx);
      phy->set_param(srslte::srsue::phy_interface_params::SRS_UE_HOP, msg->rr_cnfg.phy_cnfg_ded.srs_ul_cnfg_ded.srs_hopping_bandwidth);
      phy->set_param(srslte::srsue::phy_interface_params::SRS_UE_CYCLICSHIFT, msg->rr_cnfg.phy_cnfg_ded.srs_ul_cnfg_ded.cyclic_shift);
      phy->set_param(srslte::srsue::phy_interface_params::SRS_UE_TXCOMB, msg->rr_cnfg.phy_cnfg_ded.srs_ul_cnfg_ded.tx_comb);
      phy->set_param(srslte::srsue::phy_interface_params::SRS_IS_CONFIGURED, 1);
    }
  }
  ...
  mac->set_param(srslte::srsue::mac_interface_params::HARQ_MAXTX, 
                 liblte_rrc_max_harq_tx_num[msg->rr_cnfg.mac_main_cnfg.explicit_value.ulsch_cnfg.max_harq_tx]);
  mac->set_param(srslte::srsue::mac_interface_params::SR_TRANS_MAX, 
                 liblte_rrc_dsr_trans_max_num[msg->rr_cnfg.phy_cnfg_ded.sched_request_cnfg.dsr_trans_max]);
  mac->set_param(srslte::srsue::mac_interface_params::SR_PUCCH_CONFIGURED, 1);
  
  mac->set_param(srslte::srsue::mac_interface_params::BSR_TIMER_RETX, 
                 liblte_rrc_retransmission_bsr_timer_num[msg->rr_cnfg.mac_main_cnfg.explicit_value.ulsch_cnfg.retx_bsr_timer]);
  mac->set_param(srslte::srsue::mac_interface_params::BSR_TIMER_PERIODIC, 
...
srslte::srsue::phy phy; 
srslte::srsue::mac mac; 
srslte::srsue::mac_pcap mac_pcap; 
...
class rlctest : public srslte::srsue::rlc_interface_mac {
public:
  bool mib_decoded; 
  bool sib1_decoded; 
  bool sib2_decoded; 
  ...
  int read_pdu(uint32_t lcid, uint8_t *payload, uint32_t nof_bytes) 
  {
    if (lcid == 0) {
      ...
      mac.set_param(srslte::srsue::mac_interface_params::CONTENTION_ID, uecri);
    ...
    if (lcid == 0) {
      ...
      switch (dl_ccch_msg.msg_type) {
        ...
        case LIBLTE_RRC_DL_CCCH_MSG_TYPE_RRC_CON_REJ:
          mac.set_param(srslte::srsue::mac_interface_params::RNTI_C, 0);
          break;
      } 
    } else if (lcid == 1) {
  ...
  void     write_pdu_bcch_dlsch(uint8_t *payload, uint32_t nof_bytes) 
  {
    ...
    if (dlsch_msg.N_sibs > 0) {
      if (dlsch_msg.sibs[0].sib_type == LIBLTE_RRC_SYS_INFO_BLOCK_TYPE_1 && !sib1_decoded) {
        ...
        sib1_decoded = true;         
        mac.set_param(srslte::srsue::mac_interface_params::BCCH_SI_WINDOW_ST, -1);
  ...
  while(1) {
    ...
    if (my_rlc.mib_decoded && mac.get_current_tti()) {
      if (!my_rlc.sib1_decoded) {
        ...
        mac.set_param(srslte::srsue::mac_interface_params::BCCH_SI_WINDOW_ST, sib_start_tti(tti, 2, 5));
        mac.set_param(srslte::srsue::mac_interface_params::BCCH_SI_WINDOW_LEN, 1);                
      } else if (!my_rlc.sib2_decoded) {        
        usleep(10000);
        tti = mac.get_current_tti(); 
        mac.set_param(srslte::srsue::mac_interface_params::BCCH_SI_WINDOW_ST, sib_start_tti(tti, my_rlc.sib2_period, 0));
        mac.set_param(srslte::srsue::mac_interface_params::BCCH_SI_WINDOW_LEN, my_rlc.si_window_len);              
      }
    }
    usleep(50000);
  }
