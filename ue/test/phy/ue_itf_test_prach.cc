...
void config_phy() {
  my_phy.set_param(srslte::srsue::phy_interface_params::PRACH_CONFIG_INDEX, 0);
  my_phy.set_param(srslte::srsue::phy_interface_params::PRACH_FREQ_OFFSET, 0);
  my_phy.set_param(srslte::srsue::phy_interface_params::PRACH_HIGH_SPEED_FLAG, 0);
  my_phy.set_param(srslte::srsue::phy_interface_params::PRACH_ROOT_SEQ_IDX, 0);
  my_phy.set_param(srslte::srsue::phy_interface_params::PRACH_ZC_CONFIG, 11);

  my_phy.set_param(srslte::srsue::phy_interface_params::DMRS_GROUP_HOPPING_EN, 0);
  my_phy.set_param(srslte::srsue::phy_interface_params::DMRS_SEQUENCE_HOPPING_EN, 0);
  my_phy.set_param(srslte::srsue::phy_interface_params::PUSCH_HOPPING_N_SB, 2);
  my_phy.set_param(srslte::srsue::phy_interface_params::PUSCH_RS_CYCLIC_SHIFT, 0);
  my_phy.set_param(srslte::srsue::phy_interface_params::PUSCH_RS_GROUP_ASSIGNMENT, 0);
  my_phy.set_param(srslte::srsue::phy_interface_params::PUSCH_HOPPING_OFFSET, 0);

  my_phy.set_param(srslte::srsue::phy_interface_params::PUCCH_DELTA_SHIFT, 2);
  my_phy.set_param(srslte::srsue::phy_interface_params::PUCCH_CYCLIC_SHIFT, 0);
  my_phy.set_param(srslte::srsue::phy_interface_params::PUCCH_N_PUCCH_1, 1);
  my_phy.set_param(srslte::srsue::phy_interface_params::PUCCH_N_RB_2, 2);
